...
/**
 * @defgroup shared-memory-tests Tests for shared-memory
 * @ingroup shared-memory
 * @ingroup tests
 */

// This is an example TestCase.
/**
 * @ingroup shared-memory-tests
...
/**
 * @ingroup shared-memory-tests
 * TestSuite for module shared-memory
 */
...
SharedMemoryTestSuite::SharedMemoryTestSuite()
    : TestSuite("shared-memory", Type::UNIT)
{
    // Duration for TestCase can be QUICK, EXTENSIVE or TAKES_FOREVER
    AddTestCase(new SharedMemoryTestCase1, TestCase::Duration::QUICK);
}
 ...
 */
static SharedMemoryTestSuite ssharedMemoryTestSuite;
